/**
 * ÉCRAN ADMIN - MODIFIER UN PRODUIT
 * 
 * Cet écran permet aux administrateurs de modifier un produit existant.
 */
...
import { ProductRequest, Category, Product } from '../../types';
...
export default function EditProductScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      setSelectedCategoryId(productData.categoryID || null);
    } catch (error: any) {
